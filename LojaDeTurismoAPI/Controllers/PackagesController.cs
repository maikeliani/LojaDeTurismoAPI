...
namespace LojaDeTurismoAPI.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class PackagesController : ControllerBase
    {
        private readonly LojaDeTurismoAPIContext _context;

        public PackagesController(LojaDeTurismoAPIContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Package>> PostPackage(Package package)
        {
          if (_context.Package == null)
          {
              return Problem("Entity set 'LojaDeTurismoAPIContext.Package'  is null.");
          }
